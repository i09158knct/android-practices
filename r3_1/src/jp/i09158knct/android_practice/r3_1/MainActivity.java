...
public class MainActivity extends ListActivity {
	...
	public static final String EXTRA_KEY_ROUTE = "jp.i09158knct.android_practive.r3_1.route";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			RouteListAdapter adapter = new RouteListAdapter(this, android.R.layout.simple_list_item_1, names);
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		try {
			...
			Intent intent = new Intent(this, RouteDetailActivity.class)
					.putExtra(EXTRA_KEY_ROUTE, route.toString());
